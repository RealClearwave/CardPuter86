...
PC Speaker audio is generated by a FreeRTOS task pinned to Core 0, then written to I2S DMA in 128-sample batches. The default `cardputer86.img` includes `SNDTEST.COM`; run it from DOS to play a short PIT/port `61h` speaker test.
