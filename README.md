...
PC Speaker audio is generated by a FreeRTOS task pinned to Core 0, then written to I2S DMA in 128-sample batches. This keeps PIT channel 2 tones independent from the display refresh path and leaves the 8086 emulator loop on the Arduino core.
